...
val rule2 : st_sage -> ppe -> int -> (bool * circuit * circuit * ppe * ppe * bool)

val rule3 : st_sage -> ppe -> int -> (bool * circuit * circuit * ppe * ppe * bool)

val rule4 : st_sage -> ppe -> int -> (bool * circuit * circuit * ppe * ppe * bool)
