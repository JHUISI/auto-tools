...
void Dse09::setup(CharmList & mpk, CharmList & msk)
{
    ...
    v3 = group.random(ZR_t);
    v3G1 = group.exp(gG1, v3);
    v3G2 = group.exp(gG2, v3);
...
void Dse09::encrypt(CharmList & mpk, GT & M, string & id, CharmList & ct)
{
    ...
    E1 = group.exp(group.mul(group.mul(group.exp(uG2, idhash2), group.exp(wG2, tagc)), hG2), t);
    E2 = group.exp(gG2, t);
    ct.insert(0, C0);
    ct.insert(1, C1);
    ct.insert(2, C2);
...
void Dse09::decrypt(CharmList & ct, CharmList & sk, GT & M)
{
    ...
    A1 = group.mul(group.pair(D1, C1), group.mul(group.pair(D2, C2), group.mul(group.pair(D3, C3), group.mul(group.pair(D4, C4), group.pair(D5, C5)))));
    A2 = group.mul(group.pair(D6, C6), group.pair(D7, C7));
    A3 = group.div(A1, A2);
    A4 = group.mul(group.pair(D7, E1), group.exp(group.pair(K, E2), -1));
