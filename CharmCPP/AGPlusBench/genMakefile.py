...
def buildMakefile(config_file, flag, cppFiles, makefileName):
    ...
    if len(cppFiles) > 1:
        ...
        makefileStr = makefile % (timestamp, options['prefix'], options['CXX'], CXXFLAGS, options['incdir'], localPathToHeaders, cppFileName, "", charmLibOpt, cmd)        
    print(makefileStr)
