#if TESTDSEBOTH == 1
#include "TestDSEBoth.h"
 #define PRINT_BANNER "Test Case: Running DSE both test"
#elif TESTDSEBOTHEX == 1
 #include "TestDSEBothEx.h"
 #define PRINT_BANNER "Test Case: Running DSE both ex test"
#endif
