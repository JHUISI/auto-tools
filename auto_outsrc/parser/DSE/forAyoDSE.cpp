...
void Dsewaters09::keygen(CharmList & mpk, CharmList & msk, string & id, ZR & uf0, ZR & bf0, ZR & uf1, CharmList & skBlinded)
{
    string idBlinded;
    G1 gG1;
    G2 gG2;
    ...
    tagUSkBlinded = group.exp(tagUSk, group.div(1, bf0));
    r = group.add(r1, r2);
    ...
    K = group.exp(group.mul(group.mul(group.exp(uG1, idUShash), group.exp(wG1, tagUSkBlinded)), hG1), r1);
...
void Dsewaters09::decout(CharmList & transformOutputList, ZR & bf0, ZR & uf0, ZR & uf1, GT & M)
{
    GT C0 = group.init(GT_t);
    ZR tag;
