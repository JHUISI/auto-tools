...
for i in {1..10}
do
    python3 runAutoGroup.py --sdl schemes/BB04IBE.sdl --config schemes/configBB04IBE.py -o TimingBB04IBE.txt -v
done

echo "Running BGW05 experiment"
for i in {1..10}
do
    python3 runAutoGroup.py --sdl schemes/bgw05.sdl --config schemes/configBGW.py -o TimingBGW05.txt -v
done
